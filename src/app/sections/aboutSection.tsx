      ...
      <div className="max-w-[1428px] justify-center mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex flex-col p-3.5 lg:p-0 max-w-xl">
          ...
          <div className="mb-6">
            ...
            <div className="p-1"></div>
            <p className="text-gray-900 leading-relaxed font-light tracking-wider">
          ...
          <div>
            ...
            <ul className="list-disc pl-5 leading-relaxed tracking-wider font-light text-gray-900 space-y-2 mt-2">
              <li>
